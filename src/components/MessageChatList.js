...
const styles = StyleSheet.create({
  ...
  searchInput: {
    flex: 1, marginLeft: wp(2), fontSize: wp(3.2),
    color: "#000",
  }, filterContainer: {
    flexDirection: "row",
    marginTop: hp(1.5), marginBottom: hp(1), paddingHorizontal: wp(4),
  },

  filterChip: {
    paddingHorizontal: wp(4),
    paddingVertical: hp(0.8), borderRadius: wp(6),
  ...
  chatItem: {
    ...
    paddingVertical: hp(1.2), backgroundColor: "#fff",
  },
  avatarContainer: {
    position: "relative",
  },
