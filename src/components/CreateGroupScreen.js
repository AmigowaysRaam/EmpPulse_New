...
import {
  ActivityIndicator, FlatList, Keyboard, Modal, StyleSheet, Text, TextInput, TouchableOpacity,
  View
} from "react-native";
...
const CreateGroupScreen = ({ visible, }) => {
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContainer, {
            ...
            <TextInput
              ...
              style={[
                styles.modalInput,
                groupNameError && { borderColor: "red" },
              ]}
              placeholderTextColor="#111"
            />
...
const styles = StyleSheet.create({
  ...
  modalOverlay: {
    ...
    borderRadius: 15,
    padding: 20,
  }, modalTitle: { fontSize: 20, fontWeight: "700", marginBottom: 20, color: "#111", },
  modalInput: {
